    ...
    return (
        <div className="home">
            ...
            <div>
                ...
                <h1 className="text-light">Take a Service</h1> 
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Knowing something before Travelling</h4>
                    <h4>Why choose us</h4>
                    <h6>1. BOOKING WITH <br /> SPREAD PAYMENTS</h6>
                    <h6>2. SLEEP & TRAVEL <br /> IN COMFORT</h6>
                    <h6>3. FULLY LICENSED <br />
                         TOUR OPERATOR</h6>
                </div>
            </div>
        </div> <br />
